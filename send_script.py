...
import cv2
from send_script.game import play
...
def main(args=None):
    ...
    # targetP1 = "350.00, 350, 250, -180.00, 0.0, 135.00"
    ...
    targetP1 = "350.00, 350, 650, -180.00, 0.0, 135.00"

    #targetP1 = "450.00, 450, 130, -180.00, 0.0, 135.00"
    #targetP1 = "700.00, 200.0, 650, -180.00, 0.0, 45.00"
...
#--------------------------------------------------
    ...
    set_io(0.) # 1.0: close gripper, 0.0: open gripper
